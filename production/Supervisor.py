...
class Supervisor(object):
    ...
    def processHandlerMsg(self):
        if not self.handlerQueue.empty():
            ...
            elif handlerMsg == Utility.QMSG_UPLOAD_USER_FAIL:
                self.statusQueue.put(Utility.QMSG_UPLOAD_USER_FAIL)
            elif handlerMsg == Utility.QMSG_UPLOAD_IMAGE_FAIL:
                self.statusQueue.put(Utility.QMSG_UPLOAD_IMAGE_FAIL)
            else:
